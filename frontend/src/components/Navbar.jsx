                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    >
                        <img
                            ...
                            alt=" Logo"
                        />
                        <span className="self-center font-semibold whitespace-nowrap text-4xl text-black-800 dark:text-white">
                            Movieflix
                        </span>
                    </Link>
